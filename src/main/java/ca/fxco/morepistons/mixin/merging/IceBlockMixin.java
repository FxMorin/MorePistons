...
import ca.fxco.pistonlib.api.block.state.BlockStatePistonMerging;
...
// Merge 3 ice blocks into packed ice
@Mixin(IceBlock.class)
public class IceBlockMixin implements BlockPistonMerging {

    @Override
    public boolean pl$usesConfigurablePistonMerging() {
        return MorePistonsConfig.doIceMerging;
    }
